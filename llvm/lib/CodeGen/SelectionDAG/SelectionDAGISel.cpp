...
bool SelectionDAGISel::runOnMachineFunction(MachineFunction &mf) {
  ...
  if (Fn.getName() == "inet6_dump_addr") {
    dbgs() << "###\n";
    for (auto &BB : Fn) {
      if (BB.getName() == "for.body.i.preheader") {
        for (auto &I : BB) {
          I.dump();
          I.getInstIndex()->dump();
          dbgs() << '\n';
...
void SelectionDAGISel::SelectBasicBlock(BasicBlock::const_iterator Begin,
  ...
  // if (Begin->getParent() && Begin->getParent()->getName() == "if.end61.i.i") {
  //   dbgs() << "####begin SelectBasicBlock\n";
  //   Begin->getParent()->dump();
  // }
  ...
  for (BasicBlock::const_iterator I = Begin; I != End && !SDB->HasTailCall; ++I) {
    if (!ElidedArgCopyInstrs.count(&*I)) {
      ...
      // }
      SDB->visit(*I);
      // if (Begin->getParent() && Begin->getParent()->getName() == "entry"
      //     && Begin->getParent()->getParent() && Begin->getParent()->getParent()->getName() == "ntfs_collate_binary") {
      //   dbgs() << "####after visit\n";
  ...
  // if (Begin->getParent() && Begin->getParent()->getName() == "land.rhs.i439") {
  //   dbgs() << "####SelectBasicBlock\n";
